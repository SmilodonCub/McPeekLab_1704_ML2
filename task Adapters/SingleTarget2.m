classdef SingleTarget2 < mladapter
    %same as SingleTarget2 but added property 'IsViewing'
    %IsViewing indicates the eye position is on a TaskObject & within the
    %threshold
    properties
        Target = [0 0];
        Threshold = 0;
    ...
    methods
        function obj = SingleTarget2(varargin)
        ...
        function continue_ = analyze(obj,p)
            ...
            if 0==p.scene_frame()
                obj.LastData = in(1);
                obj.LastCrossTime = obj.Tracker.LastSamplePosition;
            end
