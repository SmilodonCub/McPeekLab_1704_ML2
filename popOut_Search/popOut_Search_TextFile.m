...
function popOut_Search_TextFile( target_eccentricity, num_positions, shift_angle, target_rgb, target_radius)
...
%task specific
task_folder = 'C:\MonkeyLogic2\Experiments\popOut_Search';
timing_file = 'popOut_Search';
